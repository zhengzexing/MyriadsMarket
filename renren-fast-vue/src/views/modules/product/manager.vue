    ...
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form :inline="true" :model="dataForm">
        ...
        <el-form-item label="价格">
          <el-input-number style="width:200px" v-model="dataForm.price.min" :min="0"></el-input-number>-
          <el-input-number style="width:200px" v-model="dataForm.price.max" :min="0"></el-input-number>
        </el-form-item>
